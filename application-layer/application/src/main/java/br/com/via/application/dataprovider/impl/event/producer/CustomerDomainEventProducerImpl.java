package br.com.via.application.dataprovider.impl.event.producer;

import br.com.via.application.dataprovider.impl.event.producer.converter.CustomerDomainEventConverter;
import br.com.via.application.dataprovider.impl.event.record.CustomerDomainEventRecord;
import br.com.via.application.dataprovider.impl.event.transactionaloutbox.TransactionalOutboxInstruction;
import br.com.via.application.dataprovider.impl.event.transactionaloutbox.TransactionalOutboxMechanism;
import br.com.via.application.dataprovider.impl.persistence.entity.CustomerEntity;
import br.com.via.application.dataprovider.impl.persistence.entity.CustomerOutboxEntity;
