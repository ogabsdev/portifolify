package br.com.via.application.entrypoint.consumer;

import br.com.via.application.config.broker.KafkaConsumerConfig;
import br.com.via.application.dataprovider.impl.event.record.common.DomainEventEnvelope;
